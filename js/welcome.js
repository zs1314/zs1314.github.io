...
$.ajax({
    ...
    data: {
        key: 'TNPBZ-AK7WH-4HMDO-WP3OO-FZ6MT-5OF7P',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(118.80242, 32.06465, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
